        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm = {4} lg = {4}>
            ...
            <Box className = "links-container" style={{marginTop: 20}}>
              <Link to = "/about" style={{color: 'white'}}>Developers</Link>
              <Link to = "/faq" style={{color: 'white', marginLeft: 10}}>FAQ</Link>
            </Box>
            <Box style={{marginTop: 20}}>
              <Link to="/linkedin" style={{color: 'white'}}>
                <LinkedInIcon style={{fontSize: '2.5rem', marginRight: 10}} />
              </Link>
              <Link to="/twitter" style={{color: 'white'}}>
                <TwitterIcon style={{fontSize: '2.5rem', marginRight: 10}} />
              </Link>
              <Link to="/instagram" style={{color: 'white'}}>
                <InstagramIcon style={{fontSize: '2.5rem', marginRight: 10}} />
              </Link>
            </Box>
          </Grid>
          <Grid item xs={12} sm = {4} lg = {4}>
